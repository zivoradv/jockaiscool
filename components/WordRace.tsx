    ...
    if (r.host === pid) {
      ...
      if (isCorrect) {
        ...
        if (other) {
          ...
          if (oSnap.exists()) {
            ...
            if (og.round === r.round && og.correct && og.time < now)
              winner = other.id
          }
        }
      ...
      setTimeout(async () => {
        ...
        if (hSnap.exists()) {
          ...
          if (hg.round === r2.round && hg.correct && hg.time < now)
            winner = host.id
        }
        ...
        {screen === "playing" && (
          <div className="gn-content">
            ...
            <div className="gn-card" style={{ gap: 0 }}>
              <p className="gn-center gn-small gn-muted">
              ...
              {submitted ? (
                <div className="wr-submitted">
                  ✅ Submitted — waiting for {them?.name ?? "partner"}…
                </div>
              ) : (
