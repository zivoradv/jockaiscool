    ...
    <div className="gn-content">
      ...
      <div className="gn-card">
        ...
        <div className="gn-chip">
          <div className="gn-avatar gn-avatar-me">
        ...
        {them ? (
          <div className="gn-chip">
            <div className="gn-avatar gn-avatar-them">
...
export function GameLanding({
  ...
  return (
    <div className="gn-content">
      ...
      <div className="gn-logo gn-logo-sm">
        {gameEmoji} {gameName}
      </div>
      <div className="gn-tagline" style={{ marginBottom: 20 }}>
        Enter your name and a room code to play
      </div>
      <div className="gn-card">
        <input
          className="gn-inp"
        ...
        <input
          className="gn-inp"
          placeholder="Room code (e.g. LOVE23)"
          value={code}
          maxLength={12}
        ...
        <p className="gn-hint">
          The host creates, the partner joins with the same code!
        </p>
      </div>
    </div>
  )
    ...
    <>
      ...
      <div className="gn-scorebar">
        <div className="gn-spl">
          ...
          <div className="gn-spl-score" style={{ color: myColor }}>
            {myScore}
          </div>
        </div>
        ...
        <div className="gn-spl">
          ...
          <div className="gn-spl-score" style={{ color: themColor }}>
            {themScore}
          </div>
        </div>
      </div>
  ...
  return (
    <div className="gn-content">
      <div className="gn-card" style={{ alignItems: "center", gap: 0 }}>
        ...
        <p className="gn-hint">
          Room: <strong style={{ color: "var(--gold)" }}>{code}</strong>
        </p>
      </div>
    </div>
  )
